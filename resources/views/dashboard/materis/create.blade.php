...
<div class="card">
    <div class="card-body">
        ...
        <div class="col-lg-8">
            <form method="post" action="{{ route('input-materi') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="nama_materi" class="form-label">Nama</label>
                    <input type="text" class="form-control @error('name_materi') is-invalid @enderror" id="nama_materi" name="nama_materi" value="{{ old('nama_materi') }}">
                    @error('nama_materi')
