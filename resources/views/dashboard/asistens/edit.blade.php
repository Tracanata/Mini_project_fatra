        ...
        <div class="col-lg-8">
            <form method="post" action="{{ route('update-user', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $user->username) }}">
                    @error('username')
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="roles">
                        ...
                        <option value="pj" {{ old('roles', $user->roles)=='pj' ? 'selected' : '' }}>PJ</option>
                        <option value="asisten" {{ old('roles', $user->roles)=='asisten' ? 'selected' : '' }}>Asisten</option>
                    </select>
                </div>
